...
export function Welcome() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#10B981] via-[#059669] to-[#047857] flex flex-col items-center justify-between px-6 py-12 max-w-md mx-auto relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="w-full space-y-4 relative z-10">
        <button
          ...
          className="w-full bg-white text-[#10B981] py-4 px-6 rounded-full font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-200 active:scale-[0.98] flex items-center justify-center gap-3"
        >
